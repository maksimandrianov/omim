...
namespace generator
{
void FeatureMakerSimple::ParseParams(FeatureParams & params, OsmElement & p)
{
...
bool FeatureMakerSimple::BuildFromRealtion(OsmElement & p, FeatureParams const & params)
{
...
void FeatureMaker::ParseParams(FeatureParams & params, OsmElement & p)
{
