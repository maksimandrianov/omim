...
// except for bad geometry. This class is suitable for most different cases.
...
protected:
  ...
  void ParseParams(FeatureParams & params, OsmElement & p) override;
...
private:
  ...
  bool BuildFromRealtion(OsmElement & p, FeatureParams const & params) override;
};
