...
namespace generator
{
CityBoundaryProcessor::CityBoundaryProcessor(shared_ptr<OsmIdToBoundariesTable> boundariesTable)
...
{
  auto const type = TypeHelper::Instance().GetPlaceType(fb.GetParams());
  ...
  UnionEqualPlacesIds(Place(fb, type, false /* saveTypes */));
}
