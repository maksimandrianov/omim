...
public:
  ...
  bool GetFeature(FeatureBuilder1 & feature);
  size_t Size() const;
  bool Empty() const;
...
protected:
  ...
  virtual bool BuildFromRealtion(OsmElement & p, FeatureParams const & params) = 0;

  virtual void ParseParams(FeatureParams & params, OsmElement & p) = 0;
